                ...
                <View style={{ flex: 1 }}>
                    ...
                    >
                        <View style={{ flex: 1, backgroundColor: '', paddingTop: 50 }}>
                            <Text style={{ fontSize: 18, fontWeight: '700', paddingHorizontal: 10, textAlign:'center',color:'white' }}>
                               Terbaik dari artis
                            </Text>
                            <Text style={{ fontSize: 12, fontWeight: '700', paddingHorizontal: 10,textAlign:'center',color:'white' }}>
                               Menyajikan lagu-lagu top artist
                            </Text>
